...
public class SuperMarioController : MonoBehaviour {
	...
	private SuperMarioIA mario;

	void Awake() {
		moveDirection = transform.TransformDirection(Vector3.forward);
		mario = transform.gameObject.AddComponent<SuperMarioIA>();
		mario.SetTarget(target1, target2);
	}
	...
	void UpdateSmoothedMovementDirection() {
		...
		Vector3 targetDirection = mario.GetHorizontal() * right + mario.GetVertical() * forward;
